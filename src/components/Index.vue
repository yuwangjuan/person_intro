<template>
    <div class="index-vue">
        ...
        <aside :class="asideClassName">
            <!-- logo -->
            <div class="logo-c">
                <img src="../assets/imgs/hz.jpg" alt="logo" class="logo">
                <span v-show="isShowAsideTitle">GEEK-OFFER</span>
            </div>
            <!-- 菜单栏 -->
                ...
                <div class="view-c">
                    <keep-alive >
                        ...
                        <!-- <router-view v-if="isShowRouter"/> -->
                         <Home v-if="isShowRouter==false"></Home>
                         <Tuijian v-if="isShowRouter==true"></Tuijian>
                    </keep-alive>
...
.sec-right {
  ...
  overflow: hidden;
  background:url('../assets/imgs/bg09.jpg') no-repeat ;
  background-size:100% 100%;
  /* background: rgba(6,40,76,0.9); */
}
/* 主体页面头部 */
header {
  height: 50px;
...
<style>
.ivu-menu-dark {
    background: rgba(33, 80, 136, 0.76) !important;
}
</style>
